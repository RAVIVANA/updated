...
public class LoanApplicationViewModel {
	...
	public void copyFromEntity(LoanApplication loanApplication) {
		...
		setCustomerId(loanApplication.getCustId());
		...
		setCreatedBy(loanApplication.getCreatedBy());
		setCreatedDate(loanApplication.getCreatedDate());
		setProcessedBy(loanApplication.getProcessedBy());
		...
		setLastUpdatedUser(loanApplication.getLastUpdatedUser());
