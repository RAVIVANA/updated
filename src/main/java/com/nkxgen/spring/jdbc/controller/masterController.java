...
//	private LoansRepository rs;
	...
	public String getSelectedAccountDetails(@RequestParam("accountType") String accountType, Model model) {
	...
	public String getSelectedLoanDetails(@RequestParam("loanType") String loanType, Model model) {
